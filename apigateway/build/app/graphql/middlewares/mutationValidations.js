...
var mutationValidators = _interopRequireWildcard(require("./validators"));
...
var _default = {
  Mutation: function () {
    ...
    regeneratorRuntime.mark(function _callee(resolve, root, args, context, info) {
      var mutationField, user, validator, values;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              mutationField = info.schema.getMutationType().getFields()[info.fieldName];
              _context.next = 3;
            ...
            case 8:
              validator = mutationValidators[info.fieldName];
    ...
    function Mutation(_x, _x2, _x3, _x4, _x5) {
